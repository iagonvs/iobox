...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Controle - TODOS REGISTROS</h3>                                    
    </div><!-- /.box-header -->
  <div class="box-body table-responsive">
        ...
        <div class="">
          ...
          <button style="margin-bottom: 2px;" type="submit" class="btn btn-primary">Impressoras em manutenção</button>
        </a>
          </div>
          <div class="">
            <a href="{{route('listar_controle_impressora_volta')}}">
            <button style="" type="submit" class="btn btn-primary">Impressoras que voltaram da manutenção</button>
          </a>
            </div>
          </div>
        <br>
...
<table id="example1" class="table table-bordered table-striped" style="margin-top: 116px;">
    ...
    <tbody>
      <tr>
        ...
        <form id="form-delete" onclick="return confirm('Deseja excluir?');" action="{{route('cadastrar_controle_impressora.destroy', $listar->idControle_Impressora)}}" method="POST">
          @csrf
          @method('DELETE')
        <td><button onclick="return confirm('Deseja excluir?');" id="form-delete" class="fa fa-trash-o" aria-hidden="true" type="submit"></button></td>
        </form>
