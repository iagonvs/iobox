...
<meta charset="UTF-8">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Setor/Agência</h3>                                    
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                <div class="col-sm-6">
                    <form action="{{ route('listar_setor_agencia') }}" method="post">
                        @csrf
                ...
                <div class="col-lg-24">
                    <a href="{{route('cadastrar_setor_agencia')}}">
    ...
    <tbody>
      <tr>
        <th scope="row">{{$listar->idSetor_Agencia}}</th>
        <td>{{$listar->Setor_Agencia}}</td>
        
        <td><a href="cadastrar_setor_agencia/{{$listar->idSetor_Agencia}}/edit">Editar</a></td>
        <form onclick="return confirm('Deseja excluir?');" action="{{route('cadastrar_setor_agencia.destroy', $listar->idSetor_Agencia)}}" method="POST">
          @csrf
          @method('DELETE')
    ...
    {{ $setor_agencia->appends(['search' => $search])->links() }}
  </table>
</div>
</div>
<!-- jQuery 2.0.2 -->
