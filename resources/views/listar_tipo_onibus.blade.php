...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Tipo Onibus</h3>                                    
    </div><!-- /.box-header -->
    {{-- <div class="box-body table-responsive">
        ...
        <div class="col-lg-24">
        <a href="{{route('cadastrar_tipo_onibus')}}">
        <button type="submit" class="btn btn-primary">Cadastrar Tipo de Onibus</button>
      </a>
        </div>
        <br>
        <br>
<table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
      <tr>
        <th scope="row">{{$listar->idTipo_Bus}}</th>
        <td>{{$listar->Tipo_Bus}}</td>
       
        <td><a href="{{route('cadastrar_tipo_onibus.edit', $listar->idTipo_Bus)}}">Editar</a></td>
      
        <form action="{{route('cadastrar_tipo_onibus.destroy', $listar->idTipo_Bus)}}" method="POST">
          @csrf
          @method('DELETE')
